...
IniRead, Ridges, 			Data\Variables.ini, variables, Ridges, NH-Bi
IniRead, Grooves, 			Data\Variables.ini, variables, Grooves, NH-PEG
IniRead, Note, 	Data\Variables.ini, variables, Note, Filename
IniRead, ExpTime, 			Data\Variables.ini, variables, ExpTime, 1
IniRead, index, 			Data\Variables.ini, variables, index, 1
IniRead, noCoupling, 		Data\Variables.ini, variables, noCoupling, 0
IniRead, noSafe, 			Data\Variables.ini, variables, noSafe, 0
IniRead, noWarmup, 			Data\Variables.ini, variables, noWarmup, 1
IniRead, nbrofLoops, 		Data\Variables.ini, variables, nbrofLoops, 1
IniRead, WaitLoop, 			Data\Variables.ini, variables, WaitLoop, 0
IniRead, nbrOfImages, 		Data\Variables.ini, variables, nbrOfImages, 1000
IniRead, WaitSubImage, 		Data\Variables.ini, variables, WaitSubImage, 10
...
IniWrite, %Ridges%, 			Data\Variables.ini, variables, Ridges
IniWrite, %Grooves%, 			Data\Variables.ini, variables, Grooves
IniWrite, %Note%, 	Data\Variables.ini, variables, Note
IniWrite, %ExpTime%, 			Data\Variables.ini, variables, ExpTime
IniWrite, %index%, 				Data\Variables.ini, variables, index
IniWrite, %noCoupling%, 		Data\Variables.ini, variables, noCoupling
IniWrite, %noSafe%, 			Data\Variables.ini, variables, noSafe
IniWrite, %noWarmup%, 			Data\Variables.ini, variables, noWarmup
IniWrite, %nbrofLoops%, 		Data\Variables.ini, variables, nbrofLoops
IniWrite, %WaitLoop%, 			Data\Variables.ini, variables, WaitLoop
IniWrite, %nbrOfImages%, 		Data\Variables.ini, variables, nbrOfImages
IniWrite, %WaitSubImage%, 		Data\Variables.ini, variables, WaitSubImage
;################################################################################################
