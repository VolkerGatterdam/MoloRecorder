...
;###Making and Saving a Image ####################################################################
				...
				Click, 930,  440																	;Click "Save image"
					...
					SendInput, %position%_%index%_[%Ridges%¦%Grooves%]_%Note%_%Instrument%_%Grayfilter%-gray_%ExpTime%s_%EMfilter%_%Focus%-focus_%MyDate%{ENTER}		;Text input and "Enter"
